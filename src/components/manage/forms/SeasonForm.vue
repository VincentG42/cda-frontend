<template>
  <form @submit.prevent="handleSubmit" class="space-y-4">
    <div>
      ...
      <input type="text" id="name" v-model="formData.name" class="mt-1 block w-full px-3 py-2 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" required />
    </div>
    <div>
      <label for="start_date" class="block text-sm font-medium text-gray-700">Date de début</label>
      <input type="date" id="start_date" v-model="formData.start_date" class="mt-1 block w-full px-3 py-2 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" required />
    </div>
    <div>
      <label for="end_date" class="block text-sm font-medium text-gray-700">Date de fin</label>
      <input type="date" id="end_date" v-model="formData.end_date" class="mt-1 block w-full px-3 py-2 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" required />
    </div>
