...
const userSchema = z.object({
  ...
  licence_number: z.string().nullable().optional().or(z.literal("")),
  // Optional, null or empty string
...
export { loginSchema as l, matchSchema as m, teamSchema as t, userSchema as u };
